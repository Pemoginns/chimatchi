    ...
    <div style={styles.container}>
      ...
      <div style={styles.wordSection}>
        ...
        <div style={styles.wordCard}>
          <p style={styles.wordLabel}>
            {roundData.direction === "fr→en" ? "French word" : "English word"}
          </p>
      ...
      {(choicesData || revealData) && (
        <div style={styles.choicesGrid}>
          <p style={styles.choicesLabel}>
            {roundData.direction === "fr→en" ? "What does it mean in English?" : "What does it mean in French?"}
          </p>
